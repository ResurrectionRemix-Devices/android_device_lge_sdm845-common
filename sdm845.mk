...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/wifi/p2p_supplicant.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/p2p_supplicant.conf \
...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/wifi/hostapd.conf:$(TARGET_COPY_OUT_VENDOR)/etc/hostapd/hostapd.conf \
